...
def stats(predict_dir):
    ...
    bu = np.load(predict_dir + "/bayesian/bayesian_sigmoids.npy").squeeze()
    dp = np.load(predict_dir + "/dropout/dropout_pred.npy").squeeze()
    du = np.load(predict_dir + "/dropout/dropout_sigmoids.npy").squeeze()
...
def plots(images_dir, predict_dir):
    ...
    bu = np.load(predict_dir + "/bayesian/bayesian_sigmoids.npy").flatten()
    du = np.load(predict_dir + "/dropout/dropout_sigmoids.npy").flatten()
